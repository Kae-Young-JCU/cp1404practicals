...
last_names_longer_than_11_characters = " ".join([full_name.split()[1]
                                                 for full_name in full_names
                                                 if len(full_name) > 11])
# note: to achieve the expected result, you must count the space between first and last names as a character
